    ...
    <main className={`${styles.content} ${extraClass}`}>
      ...
      <div className={styles.cards_box}>
        <Link className={styles.link} to="/recursion">
          <div className={`${styles.card} ${styles.string}`} data-cy='string'/>
        </Link>
        <Link className={styles.link} to="/fibonacci">
          <div className={`${styles.card} ${styles.fibonacci}`} data-cy='fibonacci'/>
        </Link>
        <Link className={styles.link} to="/sorting">
          <div className={`${styles.card} ${styles.arr}`} data-cy='sorting'/>
        </Link>
        <Link className={styles.link} to="/stack">
          <div className={`${styles.card} ${styles.stack}`} data-cy='stack'/>
        </Link>
        <Link className={styles.link} to="/queue">
          <div className={`${styles.card} ${styles.queue}`} data-cy='queue'/>
        </Link>
        <Link className={styles.link} to="/list">
          <div className={`${styles.card} ${styles.list}`} data-cy='list'/>
        </Link>
      </div>
